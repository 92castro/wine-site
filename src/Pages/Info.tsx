    ...
    <>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <div style={formCard}>
            ...
            <p style={infoText}>
              <a className="info" href="https://www.brewersbestkits.com/faqs.html" target="_blank">Brewer's Best Beermaking Tips</a>
            </p>
            <p style={infoText}>
              <a className="info" href="https://winexpert.com/winemaking-process/" target="_blank">Winexpert Helpful Winemaking Tips</a>
            </p>
            <p style={infoText}>
              <a className="info" href="http://winemakermag.com/" target="_blank">Winemaker Magazine</a>
            </p>
            <p style={infoText}>
              <a className="info" href="http://www.byo.com/" target="_blank">Brew Your Own Magazine</a>
            </p>
          ...
          <div style={formCard}>
            ...
            <p>
              <a className="info" href="https://www.ttb.gov/wine/wine-faqs#w4">
            ...
            <a className="info" style={{ fontSize: "90%" }} href="http://www.homebrewersassociation.org/pages/government-affairs/talking-points">http://www.homebrewersassociation.org/pages/government-affairs/talking-points</a>
            <a className="info" style={{ fontSize: "90%" }} href="http://www.homebrewersassociation.org/pages/government-affairs/statutes/colorado">http://www.homebrewersassociation.org/pages/government-affairs/statutes/colorado</a>
            ...
            <a className="info" href="http://www.homebrewersassociation.org/wp-content/uploads/2015/11/Colorado-LED-BULLETIN-15-04-Home-Brew.pdf">http://www.homebrewersassociation.org/wp-content/uploads/2015/11/Colorado-LED-BULLETIN-15-04-Home-Brew.pdf</a>
          </div>
      </Box>
    </>
  )
